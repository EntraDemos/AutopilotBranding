...
Copy-Item "$installFolder\Autopilot-Cloud.jpg" "C:\Windows\web\wallpaper\Autopilot\Autopilot-Cloud.jpg" -Force
...
# Win 11 start menu on left side
...
# Win 11 Right-click context menu restore
